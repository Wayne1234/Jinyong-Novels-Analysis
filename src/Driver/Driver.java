...
public class Driver {
    public static void main(String args[]) throws Exception {
        ...
        if(args.length==1&&args[0].equals("default")){
            ...
            LPA.run(20,"output/forLPA","output/LPAout");
            ...
            PageRank.run(20,"output/forPR","output/PRout");
            System.out.println("**All missions done");
        }
        else if(args.length==4&&!args[0].equals("default")){
            String inFile=args[0];
            String outFile=args[1];
            int LPAtimes=Integer.valueOf(args[2]);
            int PRtimes=Integer.valueOf(args[3]);
            extractNames.run(inFile,outFile+"/name");
