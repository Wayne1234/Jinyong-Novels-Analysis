...
public class Normalize {
    ...
    private static class NormMapper extends Mapper<Object,Text,Text,Text>{
    ...
    private static class NormReducer extends Reducer<Text,Text,Text,Text>{
    ...
    public static void run(String input,String output) throws Exception{
        ...
        job1.setMapperClass(Normalize.NormMapper.class);
        job1.setReducerClass(Normalize.NormReducer.class);
